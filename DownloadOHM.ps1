...
Register-ScheduledTask -TaskName "Startup" -Action $(New-ScheduledTaskAction -Execute 'C:\Program Files\OpenHardwareMonitor\OpenHardwareMonitor.exe') -TaskPath "\Open Hardware Monitor\" -RunLevel Highest -User "System" -Trigger $(New-ScheduledTaskTrigger -Settings $(New-ScheduledTaskSettingsSet -ExecutionTimeLimit 0) -AtStartup -RandomDelay (New-TimeSpan -minutes 3));
